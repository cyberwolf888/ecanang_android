...
public class MyAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        session = new Session(MyAccountActivity.this);
    ...
    public void getProfile(){
        if(isNetworkAvailable()){
            ...
            Ion.with(MyAccountActivity.this)
                    .load(url)
                    ...
                    .setCallback(new FutureCallback<JsonObject>() {
                        ...
                        public void onCompleted(Exception e, JsonObject result) {
                            ...
                            if (status.equals("1")){
                                ...
                                mEmailView.setText(data.get("email").getAsString());
                                nama_lengkap.setText(data.get("name").getAsString());
                                telp.setText(data.get("telp").getAsString());
    ...
    public void attempSave()
    {
        ...
        if (cancel) {
            ...
            if(isNetworkAvailable()){
                ...
                Log.d("jsonReq","> "+jsonReq.toString());
                Ion.with(MyAccountActivity.this)
                        .load(url)
                        .setJsonObjectBody(jsonReq)
                        .asJsonObject()
